...
class CardData:
    ...
    def to_dict(self):
        return {
            ...
            "card_info_description": self.card_info_description,
    ...
    def from_dict(cls, data):
        return cls(
            data["card_info_name"],
            data["card_info_description"],
            data["card_target_damage"],
            data["card_target_remove_block"],
            data["card_self_damage"],
            data["card_self_block"],
            data["card_self_heal"],
            data["card_change_draw_limit"],
            data["card_change_draw_limit_next_turn"],
            data["card_change_mana_limit"],
            data["card_change_mana_limit_permanent"],
            data["card_change_mana"],
            data["card_change_mana_next_turn"],
            data["card_cost"],
            data["exhaust"],
            data["delete"],
            data["sprite_path"]
